...
class ChatRequest(BaseModel):
    ...
    system_instruction: str = (
        "You are an expert pedagogical AI teaching assistant and assessment engine. "
        "Adapt your teaching style to Bloom's Taxonomy, encouraging active recall and deep understanding."
    )
